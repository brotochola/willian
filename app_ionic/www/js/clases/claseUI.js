let sombre8 = [[462, 153], [485, 154], [511, 172], [512, 175], [512, 184], [511, 186], [497, 198], [490, 201]]

//let sombre9=[[409,149], [423,148], [428,149], [436,150], [439,151], [443,155], [443,157], [439,162], [435,166]]


let sombre10 = [[93, 192], [103, 191], [106, 191], [114, 192], [119, 192], [131, 196], [135, 198], [140, 204], [145, 216], [145, 221], [144, 223], [139, 225], [133, 226], [109, 225]]

let sombre11 = [[90, 156], [97, 156], [107, 158], [117, 166], [122, 174], [124, 180], [126, 190], [125, 193], [122, 199], [111, 203], [105, 204]]
...
let sombre14 = [[472, 147], [479, 147], [495, 151], [503, 154], [517, 170], [513, 190], [507, 198], [479, 219]]
...
class UI {
    ...
    constructor() {
        ...
        this.shot2.scaleX = this.shot2.scaleY = 50 * 1920 / window.outerWidth / 612
        this.shot2.x = 1820;
        this.shot2.y = 980
        ...
        canvasGesture.addEventListener.onmousedown = (e) => { e.preventDefault(); }
        canvasGesture.ontouchstart = (e) => { if (juegoW.hasOwnProperty("fps")) this.touchStart(e); }

        canvasGesture.ontouchmove = (e) => { if (juegoW.hasOwnProperty("fps")) this.touchMove(e); }
        canvasGesture.ontouchend = (e) => { if (juegoW.hasOwnProperty("fps")) this.touchEnd(e); }
    ...
    pressMove(e) {
        ...
        let posXCanvas = Math.floor(e.touches[0].clientX * canvasGesture.width / canvasGesture.offsetWidth) / escalaStage
        let posYCanvas = Math.floor(e.touches[0].clientY * canvasGesture.height / canvasGesture.offsetHeight) / escalaStage
    ...
    calcularTrayectoria() {
        ...
        let startingVelocity = new b2Vec2(-Math.floor(Math.cos(deg2rad(willian.tiro.angulo)) * willian.tiro.fuerza * willian.coefFuerza), Math.floor(Math.sin(deg2rad(willian.tiro.angulo)) * willian.tiro.fuerza * willian.coefFuerza))
        ...
        for (let n = 1; n < 60; n++) {
            ...
            destello.x = posTemp.x
            destello.y = posTemp.y
            destello.scaleX = destello.scaleY = 0.30;
            destello.alpha = 0.83;
            nivel.destellos.addChild(destello);
   ...
   */
        ...
        if ((Date.now() - this.tiempoMouseDown) < this.tiempoParaHacerGestos) {
            ...
            userGesture[contadorTouch] = new Array(Math.floor(touchPoint.x), Math.floor(touchPoint.y));
            contadorTouch++;
            ...
            if (this.gestoReconocido != null) {
                ...
                if (this.gestoReconocido.substr(0, 1) == "u") {
                    ...
                    if (willian.tieneLaPelota() == 1 && willian.accion != "parado" && usuario.habilidades.gambeta) willian.cambiarAccion("gambeta360")
        ...
        linea += "[" + Math.floor(touch.clientX) + "," + Math.floor(touch.clientY) + "], ";
    ...
    touchStart(e) {
        ...
        this.shot.x = Math.floor(touch.clientX * canvasGesture.width / canvasGesture.offsetWidth) / escalaStage
        this.shot.y = Math.floor(touch.clientY * canvasGesture.height / canvasGesture.offsetHeight) / escalaStage
